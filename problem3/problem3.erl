...
prime_factors_of_N( Prime_Factors, 
                    Current_Div, 
                    Current_Quotient, 
                    Max_Factor ) when Current_Div > Max_Factor,
                                 Current_Quotient rem Current_Div =:= 0 
->
    [Current_Div | Prime_Factors]
;
...
prime_factors_of_N( Prime_Factors, 
                    Current_Div, 
                    Current_Quotient, 
                    _Max_Factor ) when Current_Quotient rem Current_Div == 0 
->
        prime_factors_of_N( [Current_Div | Prime_Factors],
                            Current_Div,
                            Current_Quotient div Current_Div,
                            math:sqrt(Current_Quotient div Current_Div))
;
...
prime_factors_of_N( Prime_Factors, 
                    Current_Div, 
                    Current_Quotient, 
                    Max_Factor ) when Current_Quotient rem Current_Div /= 0 
->
        prime_factors_of_N( Prime_Factors,
                            Current_Div + 2,
                            Current_Quotient,
