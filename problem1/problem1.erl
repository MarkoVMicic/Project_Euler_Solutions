...
naive( Acc, 0 ) -> Acc;
naive( Acc, 
       Current_value ) when Current_value rem 3 == 0; 
                            Current_value rem 5 == 0 
->
...
fast( Max_value ) 
->
    Fast = sum_divisible_by( 3, Max_value ) + 
           sum_divisible_by( 5, Max_value ) - 
           sum_divisible_by( 15, Max_value ),
    Fast
.
